...
# Персональная подзадача
Необходимо реализовать импорт/экспорт данных для анализа из .csv файла или любого другого файла электронных таблиц. Без данной функциональности решение проверяться не будет. Срок сдачи не изменяется, решение нужно предоставить до 31.10.24
